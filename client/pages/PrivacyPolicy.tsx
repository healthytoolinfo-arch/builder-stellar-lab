          ...
          >
            ...
            <div className="space-y-8 font-gill-sans text-base lg:text-lg leading-relaxed text-gray-800">
              ...
              <section>
                ...
                <p className="mb-4">
                  At i'm solutions, we collect information you provide directly
                  to us, such as when you contact us through our website,
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Send you updates about our products and services (with your
                    consent)
                  </li>
