        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-8 font-gill-sans text-base lg:text-lg leading-relaxed text-gray-800">
              ...
              <section>
                <h2 className="font-gill-sans font-bold text-2xl text-black mb-4">
                  1. Acceptance of Terms
                </h2>
                <p>
                  By accessing and using the i'm solutions website and services,
              ...
              <section>
                ...
                <p>
                  i'm solutions provides digital solutions and software
                  development services. We specialize in creating meaningful
                  applications with a focus on user experience, particularly in
                  the nutrition and wellness sector.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  software, are owned by i'm solutions and are protected by
              ...
              <section>
                ...
                <p>
                  We strive to maintain our services available 24/7, but we do
                  not guarantee uninterrupted access. We reserve the right to
                  suspend or terminate services for maintenance, updates, or
              ...
              <section>
                ...
                <p>
                  i'm solutions shall not be liable for any indirect,
                  incidental, special, or consequential damages arising out of
                  or in connection with your use of our services, even if we
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p>
                    <strong>Email:</strong> hello@imsolutions.com
                  </p>
                  <p>
                    <strong>Company:</strong> i'm solutions
                  </p>
                  <p>
